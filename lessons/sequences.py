...
# Meaning that you can loop over them with for...in
for item in goat:
    print(item)

# Tuples, unlike lists, are immutable
# Which means that we can not reassign, append, pop, etc...
...
# In memory, ranges have 3 components (start, stop, step) in heap.
